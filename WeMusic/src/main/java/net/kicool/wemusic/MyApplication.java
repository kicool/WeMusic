...
import net.kicool.common.utils.GAStatUtil;
import net.kicool.common.utils.LocalPathResolver;
import net.kicool.common.utils.LoggerUtil;
import net.kicool.common.utils.TTSUtil;
import net.kicool.services.ServiceProvider;
...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        TTSUtil.getInstance(context);

        GAStatUtil.init(context);
        ...
        ServiceProvider.getInstance().getServiceInstance("PeersMgr").start();
    }
    ...
    public void onLowMemory() {
        ...
        GAStatUtil.sendEvent("app_memory", "low", null, null);
    }
    ...
    public void onTerminate() {
        ...
        ServiceProvider.getInstance().getServiceInstance("PeersMgr").stop();
    }
    ...
    private static class MediaCardStateBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            LoggerUtil.d(TAG, "Media state changed, intentAction:" + intent.getAction());
